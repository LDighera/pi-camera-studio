...
The distribution-build portion uses PEP 517 isolation and may download the
build-backend versions declared in `pyproject.toml`. Runtime camera and GUI
dependencies continue to come from operating-system packages.
